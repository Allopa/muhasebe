<div class="page-content">
          <div class="header">
            <h2><strong>Giderler</strong> > Yeni Maaş / Prim</h2>
            ...
            <div class="col-md-12">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="row">
                    <form action="<?php echo SITE_URL;?>giderler/yenimaasrun" method="post" class="form-horizontal">                      
                      <div class="col-md-6">                    
                        <div class="form-group">
                            <div class="col-md-1"><i class="fa fa-user fa-3x c-textNegative"></i></div>
                        ...
                        <div class="form-group">
                          ...
                          <label class="col-sm-3">Çalışan</label>
                          <div class="col-sm-8">
                            <select class="form-control" name="calisan" data-search="true">
                        ...
                        <div class="form-group">
                          ...
                          <label class="col-sm-3">Hakediş Tarihi</label>
                          <div class="col-sm-8">
                             <input type="date" name="hakedistarihi" class="form-control" placeholder="Tarih Seçiniz...">
                              
                          </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-1"><i class="fa fa-plus-circle"></i></div>
