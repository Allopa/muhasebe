<div class="page-content">
          <div class="header">
            <h2><strong>Giderler</strong> > Yeni Vergi / SGK Primi</h2>
            ...
            <div class="col-md-12">
              <div class="panel">
                ...
                <div class="panel-content">
                  <div class="row">
                    <form action="<?php echo SITE_URL;?>giderler/yenisgkrun" method="post" class="form-horizontal">                      
                      <div class="col-md-6">                    
                        <div class="form-group">
                          ...
                          <hr />
                        <div class="form-group">
                            <div class="col-md-1"><i class="fa fa-calendar-o"></i></div>
                          <label class="col-sm-3">Vergi Dönemi</label>
                          <div class="col-sm-4">
                            <select class="form-control" name="vergiay" data-search="true">
                                  <?php foreach ($ayListe as $key => $value) { ?>	
                                    <option value="<?=$value["id"]?>"><?=$value["ay"]?></option>
                                  <?php }?>
                            </select>
                              </div>
                            <div class="col-sm-4">
                            <select class="form-control" name="vergiyil" data-search="true">
                                <?php foreach ($yilListe as $key => $value) { ?>	
                                    <option value="<?=$value["id"]?>"><?=$value["ay"]?></option>
                                  <?php }?>                                                    
                            </select>
                          </div>
