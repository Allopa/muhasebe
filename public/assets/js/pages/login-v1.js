$(function() {
    if($('body').data('page') == 'login'){
        ...
        $.backstretch(["http://localhost/muhasebe/public/assets/images/gallery/login5.jpg"],
        {
            fade: 600,
            duration: 4000
        });
        ...
        $('#image-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["http://localhost/muhasebe/public/assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
        ...
        $('#slide-cb').change(function() {
            if ($(this).is(":checked")) {
                $.backstretch(["http://localhost/muhasebe/public/assets/images/gallery/login4.jpg", "http://localhost/muhasebe/public/assets/images/gallery/login3.jpg", "assets/images/gallery/login2.jpg", "assets/images/gallery/login.jpg"], {
                    fade: 600,
                    duration: 4000
                });
