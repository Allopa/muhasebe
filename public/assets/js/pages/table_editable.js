$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[5].innerHTML = '<div class="text-right"><a class="edit btn btn-sm btn-success" href="">Kaydet</a> <a class="delete btn btn-sm btn-danger" href=""><i class="icons-office-52"></i></a></div>';
        }
        ...
        $('#table-edit_new').click(function (e) {
            ...
            var aiNew = oTable.fnAddData(['', '', '', '','',
                    '<p class="text-center"><a class="edit btn btn-dark" href=""><i class="fa fa-pencil-square-o"></i>Düzenle</a> <a class="delete btn btn-danger" href=""><i class="fa fa-times-circle"></i> Sil</a></p>'
            ]);
        ...
        $('#table-editable a.delete').live('click', function (e) {
            e.preventDefault();
            if (confirm("Silmek istediğinize eminmisiniz ?") == false) {
                return;
            }
